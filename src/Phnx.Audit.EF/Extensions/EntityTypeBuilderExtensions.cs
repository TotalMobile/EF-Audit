...
namespace Microsoft.EntityFrameworkCore
{
    public static class EntityTypeBuilderExtensions
    {
        ...
        /// <param name="auditSelector">The selector for the foreign reference to the audit</param>
        /// <returns>The entity framework type builder</returns>
        public static EntityTypeBuilder<TEntity> HasAudit<TEntity, TAuditType>(this EntityTypeBuilder<TEntity> typeBuilder, Expression<Func<TEntity, IEnumerable<TAuditType>>> auditSelector)
            where TAuditType : AuditEntryDataModel<TEntity>
            where TEntity : class
        {
            if (typeBuilder is null)
            {
